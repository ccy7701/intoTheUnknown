...
void initBlenderMeshes() {
    asteroid.load(GetObjectPath("asteroid.obj"));
    boyzMobile.load(GetObjectPath("boyzMobile-FINAL.obj"));
    boyzMobile_alt.load(GetObjectPath("boyzMobile-ALTERNATE.obj"));
    cube.load(GetObjectPath("cube.obj"));
    skeletons.load(GetObjectPath("skeleton-FINAL.obj"));
    clockTowerShip_body.load(GetObjectPath("clocktower-body.obj"));
    clockTowerShip_engine.load(GetObjectPath("clocktower-engine.obj"));
    clockTowerShip_dome.load(GetObjectPath("clocktower-dome.obj"));
    clockTowerShip_plume.load(GetObjectPath("clocktower-plume.obj"));
    sst_edgepillar.load(GetObjectPath("sst-EDGEPILLAR.obj"));
    sst_core_top.load(GetObjectPath("sst-CORE-TOP.obj"));
    sst_core_bottom.load(GetObjectPath("sst-CORE-BOTTOM.obj"));
    sst_roads.load(GetObjectPath("sst-ROADS.obj"));
    sst_roadmarks.load(GetObjectPath("sst-ROADMARKS.obj"));
    monster.load(GetObjectPath("space-monster-source.obj"));
}

void initSceneOneTextures() {
    Textures_Initialise();
    skybox.set(2.0, GetBitmapPath("nightSky.bmp"));
    baseplate.set(2.0, GetBitmapPath("grass.bmp"));
    rebalancer.set(1.0, GetBitmapPath("white-rebalancer.bmp"));
}

void initLeavingEarthTextures() {
    Textures_Initialise();
    skybox.set(2.0, GetBitmapPath("nightSky.bmp"));
    earth.set(2.0, GetBitmapPath("earth.bmp"));
}

void initSpacePanoramaTextures() {
    Textures_Initialise();
    skybox.set(2.0, GetBitmapPath("nightSky.bmp"));
    sun.set(2.0, GetBitmapPath("sunSurface.bmp"));
    mercury.set(2.0, GetBitmapPath("mercury.bmp"));
    venus.set(2.0, GetBitmapPath("venus.bmp"));
    earth.set(2.0, GetBitmapPath("earth.bmp"));
    moon.set(2.0, GetBitmapPath("moon.bmp"));
    mars.set(2.0, GetBitmapPath("mars.bmp"));
    jupiter.set(2.0, GetBitmapPath("jupiter.bmp"));
    saturn.set(2.0, GetBitmapPath("saturn.bmp"));
    saturnRings.set(2.0, GetBitmapPath("saturnRings.bmp"));
    uranus.set(2.0, GetBitmapPath("uranus.bmp"));
    neptune.set(2.0, GetBitmapPath("neptune.bmp"));
    pluto.set(2.0, GetBitmapPath("pluto.bmp"));
}
...
void initOnMoonTextures() {
    Textures_Initialise();
    skybox.set(2.0, GetBitmapPath("nightSky.bmp"));
    baseplate.set(2.0, GetBitmapPath("moonSurface.bmp"));
    flag.set(2.0, GetBitmapPath("umsflag-yellowbg.bmp"));
}
...
void initMountainTextures() {
    ...
    baseplate.set(2.0, GetBitmapPath("grass.bmp"));
    rebalancer.set(1.0, GetBitmapPath("white-rebalancer.bmp"));
    rickrollSquare.set(2.0, GetBitmapPath("rickroll-0.bmp"));
}
